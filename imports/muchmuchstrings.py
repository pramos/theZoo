...
class banners:
    ...
    def print_available_payloads(self, array):
        answer = str(array[globals.vars.column_for_uid])
        answer += "\t" + str(array[globals.vars.column_for_name])
        answer += "\t" + str(array[globals.vars.column_for_version]) + "\t\t"
        answer += str(array[globals.vars.column_for_location])
        answer += "\t\t" + str(array[globals.vars.colomn_for_time])
        print(answer)
